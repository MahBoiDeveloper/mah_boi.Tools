...
namespace mah_boi.Tools
{
    ...
    /// *---x2---*     необходимо предварительно их инвертировать, чтобы конвертирвать в нормальную строку.
    ///     
    ///     ////////////////////////////////////////////////// WRTS //////////////////////////////////////////////////
    ///     
    ...
    /// *---x2---*     И значение нигде в игре не используется, так что можно считать, что это такой же рудимент, как и код языка.
    ///     
